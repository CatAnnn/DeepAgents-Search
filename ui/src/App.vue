...
.main-content.centered-layout {
  ...
  isolation: isolate;
  background:
    radial-gradient(circle at 50% 48%, rgba(255, 255, 255, 0.96) 0 20%, rgba(255, 255, 255, 0.74) 36%, rgba(255, 255, 255, 0) 60%),
    radial-gradient(circle at 8% 86%, rgba(164, 174, 255, 0.48) 0, rgba(164, 174, 255, 0) 30%),
    radial-gradient(circle at 96% 70%, rgba(210, 186, 255, 0.45) 0, rgba(210, 186, 255, 0) 34%),
    linear-gradient(135deg, #fbfbff 0%, #f4f1ff 34%, #fff7fb 62%, #edf6ff 100%);
}
...
.main-content.centered-layout::before {
  content: "";
  position: absolute;
  left: -12vw;
  right: -12vw;
  ...
  background:
    linear-gradient(115deg, rgba(169, 181, 255, 0.5), rgba(255, 242, 250, 0.72) 46%, rgba(192, 226, 255, 0.58)),
    radial-gradient(circle at 20% 20%, rgba(255, 255, 255, 0.74), rgba(255, 255, 255, 0) 34%);
  box-shadow: inset 0 1px 0 rgba(255, 255, 255, 0.88);
  transform: rotate(-3deg);
}

.main-content.centered-layout::after {
  content: "";
  position: absolute;
  width: 92vw;
  height: 64vh;
...
.main-content.centered-layout .welcome-text {
  margin-bottom: 2.25rem;
}

.main-content.centered-layout .welcome-text h1 {
  font-size: clamp(3.8rem, 5vw, 5rem);
  font-weight: 700;
  letter-spacing: 0;
  background: linear-gradient(90deg, #3f72f6 8%, #7b59f2 58%, #a247ef 100%);
  -webkit-background-clip: text;
  -webkit-text-fill-color: transparent;
  text-shadow: 0 16px 38px rgba(99, 102, 241, 0.18);
}

.main-content.centered-layout .welcome-text h2 {
...
.main-content.centered-layout .input-container {
  width: min(860px, calc(100vw - 48px));
  max-width: 860px;
  min-height: 70px;
  box-sizing: border-box;
  padding: 0.55rem 0.9rem 0.55rem 0.75rem;
  border: 1px solid rgba(139, 148, 180, 0.18);
  border-radius: 999px;
  background: rgba(255, 255, 255, 0.9);
  box-shadow:
    0 22px 55px rgba(117, 92, 185, 0.13),
    inset 0 1px 0 rgba(255, 255, 255, 0.92);
  backdrop-filter: blur(18px);
}

.main-content.centered-layout .input-container.focused {
  background: rgba(255, 255, 255, 0.96);
}

.main-content.centered-layout textarea {
  color: #4f5b6f;
  font-size: 1rem;
  height: 28px;
}

.main-content.centered-layout textarea::placeholder {
  color: #7f899c;
  opacity: 1;
}

.main-content.centered-layout .upload-btn {
  width: 50px;
  height: 50px;
  flex: 0 0 50px;
  ...
  box-shadow:
    0 12px 28px rgba(112, 92, 185, 0.12),
    inset 0 1px 0 rgba(255, 255, 255, 0.96);
}

.main-content.centered-layout .upload-btn:hover {
  background: #ffffff;
  color: #6b47e8;
}

.main-content.centered-layout .upload-btn:disabled {
  color: #a4a9b8;
  background: rgba(255, 255, 255, 0.72);
}

.main-content.centered-layout .send-btn {
  width: 52px;
  height: 52px;
  flex: 0 0 52px;
  padding: 0;
  color: #ffffff;
  background: linear-gradient(135deg, #5c6df5 0%, #9346ed 100%);
  box-shadow: 0 14px 28px rgba(112, 77, 231, 0.28);
  transition: transform 0.2s, box-shadow 0.2s, background 0.2s;
}

.main-content.centered-layout .send-btn:disabled {
  color: #ffffff;
  cursor: default;
  opacity: 1;
  background: linear-gradient(135deg, #6676f7 0%, #9b4ef0 100%);
}

.main-content.centered-layout .send-btn:not(:disabled):hover {
  background: linear-gradient(135deg, #5062ed 0%, #843ee6 100%);
  box-shadow: 0 16px 34px rgba(112, 77, 231, 0.34);
  transform: translateY(-1px);
}

.main-content.centered-layout .footer-text {
  font-size: 0.9rem;
  color: #8c95a9;
}
